...
const App = () => {
  ...
  const portfolioItems = [
    ...
    { id: 5, category: 'LinkedIn', title: 'Infographics', description: 'infographics for certain target market.', color: 'bg-blue-50', image: 'infographics/Tips to save money.png', gallery: ['infographics/Tips to save money.png'] },
